  ...
  <div class="card-deck">
    ...
    <?php
      ...
      $args = array(
        'type' => 'post',
        'post_status' => 'publish',
        'posts_per_page' => esc_html ( get_theme_mod ('neori_doordash_backend_posts_posts_number_setting', '')),
        'category_name' => esc_html ( get_theme_mod ('neori_doordash_backend_posts_category_slug_setting', '')),
        'ignore_sticky_posts' => 1,
        'offset' => esc_html ( get_theme_mod ('neori_doordash_backend_posts_offset_posts_setting', '')),
      );
    ...
    <?php if( $slice_query->have_posts() ): while( $slice_query->have_posts() ): $slice_query->the_post(); ?>
      ...
      <?php get_template_part('template-parts/slices/content', 'doordash-backend-posts'); ?>
