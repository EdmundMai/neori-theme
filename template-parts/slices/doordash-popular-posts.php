<div class="slice type1">
  ...
  <a href="./category/<?php echo esc_html( get_theme_mod ('neori_doordash_popular_posts_category_slug_setting', '')); ?>/"><h2 class="slice-title"><?php echo esc_html( get_theme_mod ('neori_doordash_popular_posts_category_name_setting', '')); ?></h2></a>
