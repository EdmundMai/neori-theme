...
<!-- Social Icons -->
        ...
        <?php if(!get_theme_mod('neori_logo_image_setting')) : ?>
          ...
          <div class="logo-right align-items-center" style="height: 69px">

        <?php else : ?>

          <div class="logo-right align-items-center" style="height: <?php echo esc_html( get_theme_mod ('neori_logo_height_setting', '')); ?>px;">
...
<!-- AD -->
            ...
            <div class="ad">
              ...
              <?php echo wp_kses_post( get_theme_mod ('neori_header_ad_space_setting', '')); ?>
