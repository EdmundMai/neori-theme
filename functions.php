...
function neori_scripts() {
  ...
  wp_enqueue_style( 'neori-style', get_stylesheet_uri(), array(), '1.4.0', 'all' );

  wp_enqueue_style( 'bootstrap-css', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '4.0', 'all' );

  wp_enqueue_style( 'neori-modified-bootstrap-css', get_template_directory_uri() . '/css/modified-bootstrap.css', array(), '1.4.0', 'all' );
...
function neori_doordash_backend_posts() {

  ob_start();
  get_template_part( 'template-parts/slices/doordash-backend-posts' );
  return ob_get_clean();
