...
$wp_customize->add_setting(
  'neori_slice_type7_offset_posts_setting',
    array(
      'default'     => '',
      'sanitize_callback' => 'wp_filter_nohtml_kses'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_slice_type7_offset_posts_control',
				array(
          'label'      => 'OPTIONAL: Offset posts',
          'description' => 'With this option you can offset the posts shown in the Slice',
					'section'    => 'neori_slice_type7_section',
					'settings'   => 'neori_slice_type7_offset_posts_setting',
					'type'		 => 'text',
					'priority'	 => 4
				)
  )
...
$wp_customize->add_setting(
  'neori_doordash_popular_posts_category_name_setting',
    array(
      'default'     => '',
      'sanitize_callback' => 'wp_filter_nohtml_kses'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_doordash_popular_posts_category_name_control',
				array(
					'label'      => 'Category Name',
					'description' => 'used to display the Title',
					'section'    => 'neori_doordash_popular_posts_section',
					'settings'   => 'neori_doordash_popular_posts_category_name_setting',
					'type'		 => 'text',
					'priority'	 => 1
				)
  )
...
$wp_customize->add_setting(
  'neori_doordash_popular_posts_category_slug_setting',
    array(
      'default'     => '',
      'sanitize_callback' => 'wp_filter_nohtml_kses'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_doordash_popular_posts_category_slug_control',
				array(
					'label'      => 'Category Slug',
					'description' => 'just write the category slug from which you want to display posts in this Slice. In most cases it is the same as the category name. It can be found in the Dashboard > Posts > Categories section',
					'section'    => 'neori_doordash_popular_posts_section',
					'settings'   => 'neori_doordash_popular_posts_category_slug_setting',
					'type'		 => 'text',
					'priority'	 => 2
				)
  )
...
$wp_customize->add_setting(
  'neori_doordash_popular_posts_posts_number_setting',
    array(
      'default'     => '',
      'sanitize_callback' => 'wp_filter_nohtml_kses'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_doordash_popular_posts_posts_number_control',
				array(
					'label'      => 'Posts Number',
					'section'    => 'neori_doordash_popular_posts_section',
					'settings'   => 'neori_doordash_popular_posts_posts_number_setting',
					'type'		 => 'text',
					'priority'	 => 3
				)
  )
...
$wp_customize->add_setting(
  'neori_doordash_popular_posts_custom_excerpt_setting',
    array(
	   'default'     => false,
	   'sanitize_callback' => 'neori_sanitize_checkbox'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_doordash_popular_posts_custom_excerpt_control',
				array(
          'label'      => 'Custom Excerpt',
          'description' => 'If you enable this option, you will have the possibility to write your own excerpts from the Post Editor.',
					'section'    => 'neori_doordash_popular_posts_section',
					'settings'   => 'neori_doordash_popular_posts_custom_excerpt_setting',
					'type'		 => 'checkbox',
					'priority'	 => 4
				)
  )
...
$wp_customize->add_setting(
  'neori_doordash_popular_posts_offset_posts_setting',
    array(
      'default'     => '',
      'sanitize_callback' => 'wp_filter_nohtml_kses'
    )
...
$wp_customize->add_control(
  new WP_Customize_Control(
    $wp_customize,
      'neori_doordash_popular_posts_offset_posts_control',
				array(
          'label'      => 'OPTIONAL: Offset posts',
          'description' => 'With this option you can offset the posts shown in the Slice',
					'section'    => 'neori_doordash_popular_posts_section',
					'settings'   => 'neori_doordash_popular_posts_offset_posts_setting',
					'type'		 => 'text',
					'priority'	 => 5
				)
  )
